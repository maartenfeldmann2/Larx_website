...
hero:
  ...
  text: "Your firm in control, always"
  tagline: Manage clients, teams, dossiers and access rights from one secure management dashboard. Your firm decides who sees what — down to the individual person and dossier.
  actions:
    - theme: brand
      text: Book a demo
      link: /about
...
<section class="lx-section">
  <div class="lx-hero-shot">Product screenshot placeholder — management dashboard</div>
</section>
...
<section class="lx-section">
  ...
  <div class="lx-showcase lx-showcase--reverse">
    ...
    <div class="lx-showcase-image">Screenshot placeholder — dossier access matrix</div>
  </div>
  ...
  <div class="lx-showcase">
    ...
    <div class="lx-showcase-image">Screenshot placeholder — client profile</div>
  </div>
</section>

...
function checkSidebar(route) {
  if (route === '/dossier-management.html' || route === '/filesharing.html' || route === '/collaboration.html' || route === '/client-management.html' || route === '/marketing.html' || route === '/security.html') {
      console.log('hoi');
...
<template>
  <div v-if="frontmatter.layout !== false" class="Layout" :class="frontmatter.pageClass" >
    ...
    <VPSidebar v-if="showSidebar" :open="isSidebarOpen">
